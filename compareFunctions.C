...
//	vector<TFile *> files = {smashVertexZchargedTracks, smashVertexZchargedTracksWireDistanceAllLayers};
	vector<TFile *> files = {pureSmashPipnTracksMix, pureSmashPipChargedTracksMix, pureSmashPipTotalChargeMix, pureSmashPipTotalPositiveChargeMix, pureSmashPipTotalPositiveAndNegativeMix, pureSmashPipnPipMix, pureSmashPipnPipnPimMix, pureSmashPipTotalMomentumMix};
...
//	vector<char*> sigNames = {"sigUrqmdGT1", "sigUrqmdGT5", "sigSmashGT1", "sigSmashGT5"};
	vector<char*> sigNames = {"sig1","sig2","sig3","sig4","sig5","sig6","sig7","sig8"};
...
//	vector<char*> bckgNames = {"bckgUrqmdGT1", "bckgUrqmdGT5", "bckgSmashGT1", "bckgSmashGT5"};
	vector<char*> bckgNames = {"bckg1", "bckg2","bckg3","bckg4","bckg5","bckg6","bkg7","bckg8"};
...
//	vector<char*> legNames = {"wireDistanceGT4 noSharedMeta allLayers","wireDistanceGT4 allLayers"};
	vector<char*> legNames = {"nTracks mix", "charged tracks mix", "total charge mix", "total positive charge mix", "total positive and negative charge mix", "nPip", "nPip nPim", "total momentum"};
